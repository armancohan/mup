...
def get_scheduler(optimizer, config, num_steps):
    ...
    num_warmup_steps = num_steps * config.warmup_ratio

    if scheduler_name == "polynomial_decay_with_warmup":
        return get_polynomial_decay_schedule_with_warmup(optimizer, num_warmup_steps, num_steps)
        ...
        return torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, num_steps)
